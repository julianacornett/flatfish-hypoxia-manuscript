...
```{r}
sole_scope_grouped <- sole_scope %>% group_by(DO_mgL) %>% summarise(HypMMRAvg = mean(HypMMR, na.rm = TRUE), HypSMRAvg = mean(HypSMR, na.rm = TRUE), HypScopeAvg = mean(HypScope, na.rm = TRUE))
sole_scope_grouped
```
